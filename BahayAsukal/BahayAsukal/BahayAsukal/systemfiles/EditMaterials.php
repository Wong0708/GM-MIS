...
if(isset($_POST['edit'])){
    ...
    header("Location: http://".$_SERVER['HTTP_HOST'].
                dirname($_SERVER['PHP_SELF'])."/EditSelectMaterial.php");
}
                        ...
                        <?php
                            ...
                            while($row=mysqli_fetch_array($result,MYSQLI_ASSOC))
                            {
                                if($row['material_qty'] < 50)
                                    {
                                        echo '<tr><form method="post" action=""><input type="hidden" name="id" value="'.$row['materialID'].'">';
                                        echo '<td>';
                                        ...
                                        echo '<a href="CreatePO.php"><button class="btn btn-round btn-danger"type="button" name ="replenish" class="btn btn-info">Replenish</button></a></form>';
                                        echo '</td>';
                                    }
                                else
                                {
