                                                    ...
                                                    <div class="x_content">
                                                        <form class="form-horizontal form-label-left" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                                  <input type="number" id="quantity" name="quantity" required="required" class="form-control col-md-7 col-xs-12" onkeyup="checkEnoughQuantity();" value="0">
                                                                </div>
                                                                <button type="button" id="addProductButton" class="btn btn-primary" align="center" onclick="addProductToOrder();">Add to Order</button>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="col-md-6 col-sm-6 col-xs-12">
