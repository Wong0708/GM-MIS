    ...
    <body class="nav-md">
        ...
        <script>
            ...
            function updateReportTable(input, date){
                ...
                if(document.getElementById("titleStartDate").value == "0" || document.getElementById("titleEndDate").value == "0"){
                    document.getElementById("reportTitle").innerHTML = "";
                    document.getElementById("reportTable").style.visibility = "hidden";
                }
                else{
                    document.getElementById("reportTitle").innerHTML = "<h2>Inventory Report for " + document.getElementById("titleStartDate").value + " - " + document.getElementById("titleEndDate").value + "</h2>";
                    document.getElementById("reportTable").style.visibility = "visible";
                    queryReport(document.getElementById("titleStartDate").value, document.getElementById("titleEndDate").value)
                }
            }
            
            function queryReport(startDate, endDate){
                $.ajax({
                type: 'POST',
                url: "ajax/generateInventoryReport.php",
                data:{
                    startDate: startDate,
                    endDate: endDate
                },
