                      ...
                      <tbody>
                        <?php
                            ...
                            {       
                                    ...
                                    echo '</td>';
                                    echo '<td>';
                                    echo '<button type="submit" name ="view" class="btn btn-info" onclick="viewPurchaseOrderInventory('.$orderNumber.');" data-toggle="modal" data-target=".bs-example-modal-lg3">View Order Details</button>';
                                    echo '</td>';
                                    echo '</tr>';
